...
<section class=" text-gray-200 bg-gray-300">
    <div class="max-w-6xl mx-auto px-5 py-14 ">
      <div class="flex flex-wrap w-full mb-18 flex-col items-center text-center">
        <h1 class=" text-black title-font mb-2 text-4xl font-extrabold leading-10 tracking-tight text-left sm:text-5xl sm:leading-none md:text-6xl">LO MAS BARATO EN ARTESANIA</h1>
                    ...
                    <div class="absolute inset-0 transform origin-left hover:-rotate-45 transition duration-300">
                        <div class="h-full w-full bg-white text-black rounded-lg shadow-2xl">
                            ...
                            <div class="m-5">
                              ...
                              <a href="{{route('malaquita.mostrar', $descuentos)}}" class="font-bold text-black text-lg">{{$descuentos->name}}</a>
                              <div class="flex items-center justify-between">
                                <div class="text-sm text-black font-light"> Tamaño : Regular </div>
                                <div class="text-2xl text-black font-bold"> Precio ${{$descuentos->price}}</div>
                              </div>
